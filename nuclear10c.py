...
#μ = 0.0196
#outof = 31
params["nwf_beta"] = beta_from_conf(2e-4, 0.07) # dis.beta(μ*outof, (1-μ)*outof)

#Note for future: possibly the beta distributions for conditional occurrence 
#of nuclear winter and death of 10% should be weighted towards 0 and 1.
...
g = generate_samples(params, 50000)
